...
try:
    tensors = load_file("/REDACTED/PATHroject/reddy/REDACTED/PATHnal_training_testing_val_data/Soto-HIP1/model/checkpoint-156250/model.safetensors")
...
try:
    ...
    file_path = '/REDACTED/PATHroject/reddy/REDACTED/PATHnal_training_testing_val_data/Soto-HIP2/model/checkpoint-2500/global_step2500/zero_pp_rank_3_mp_rank_00_optim_states.pt'
