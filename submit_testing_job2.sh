...
sbatch -A es_reddy --job-name="${JOB_NAME}" \
    ...
    model_assessment/inference_comparison_test.py --model_path \"/REDACTED/PATHroject/reddy/REDACTED/PATHnal_training_testing_val_data/Soto-HIP2/model/checkpoint-156250\""
