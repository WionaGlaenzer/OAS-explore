...
export PROJECT_BASE="/REDACTED/PATHroject/reddy/REDACTED/PATHretraining/mouse"
...
sbatch -A es_reddy --job-name="${JOB_NAME}" \
    ...
    \"${DONE_FILE_PATH}\" \
    \"${TOKENIZER_PATH}\" \
    "/REDACTED/PATHnzer/Coding/plm_training_pipeline/assets/deepspeed_stage2_config.json" \
