...
# === USER PARAMETERS =========================================================
ROWS_PATH = Path("/REDACTED/PATHroject/reddy/REDACTED/PATHn/OAS_wo_Soto/output/sampled_sequences_round_robin.csv")           # CSV or Parquet containing the rows table
#ROWS_PATH = Path("/REDACTED/PATHroject/reddy/REDACTED/PATHn/OAS_wo_Soto/output/sequences_filtered_processed.csv")
METADATA_PATH = Path("/REDACTED/PATHnzer/Coding/plm_training_pipeline/assets/OAS_overview.csv")  # CSV mapping File_ID -> Subject, Author
